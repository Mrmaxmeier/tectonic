...
uchar_t get_uchar(UTF8_code * buf, unsigned int * ptr);
size_t write_uchar(UTF8_code * buf, uchar_t c, unsigned int * ptr);
...
extern uchar_t file_name_quote_char;
...
extern uchar_t *font_bc;
extern uchar_t *font_ec;
...
void print_ln(void);
void print_raw_char(int32_t s, bool incr_offset);
...
void print_subsidiary_data(int32_t p, uchar_t c);
...
int32_t new_native_character(internal_font_number f, uchar_t c);
