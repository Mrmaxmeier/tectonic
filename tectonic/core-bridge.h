...
typedef struct tt_bridge_api_t {
    ...
    void (*issue_error_at)(void *context, char const *file, uint64_t line, char const *text);
...
void ttstub_issue_error_at(char const *file, uint64_t line, char const *text);
